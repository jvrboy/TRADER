...
public class Trend_VWMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend VWMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend VWMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend VWMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
