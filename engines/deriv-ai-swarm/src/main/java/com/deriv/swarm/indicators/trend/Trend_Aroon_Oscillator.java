...
public class Trend_Aroon_Oscillator implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Aroon_Oscillator"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Aroon_Oscillator - trend indicator with period 25"; }

    @Override
    public int getMinCandles() { return 25; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(25, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Aroon_Oscillator: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
