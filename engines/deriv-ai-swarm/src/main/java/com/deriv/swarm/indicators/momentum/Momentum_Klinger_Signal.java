...
public class Momentum_Klinger_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Klinger_Signal"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Klinger_Signal - momentum indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Klinger_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
