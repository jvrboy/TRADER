...
public class Custom_LSTM_Prediction implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom LSTM_Prediction"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom LSTM_Prediction - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom LSTM_Prediction: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
