...
public class Volume_Klinger_Volume implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Klinger_Volume"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Klinger_Volume - volume indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Klinger_Volume: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
