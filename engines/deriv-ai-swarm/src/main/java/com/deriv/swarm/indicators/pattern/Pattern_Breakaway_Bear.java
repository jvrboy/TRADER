...
public class Pattern_Breakaway_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Breakaway_Bear"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Breakaway_Bear - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Breakaway_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
