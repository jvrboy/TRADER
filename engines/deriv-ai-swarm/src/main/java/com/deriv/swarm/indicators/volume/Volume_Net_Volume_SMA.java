...
public class Volume_Net_Volume_SMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Net_Volume_SMA"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Net_Volume_SMA - volume indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Net_Volume_SMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
