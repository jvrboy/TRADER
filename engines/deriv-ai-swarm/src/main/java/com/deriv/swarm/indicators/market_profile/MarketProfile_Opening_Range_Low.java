...
public class MarketProfile_Opening_Range_Low implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Opening_Range_Low"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Opening_Range_Low - market_profile indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Opening_Range_Low: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
