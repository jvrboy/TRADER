...
public class Pattern_Mat_Hold implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Mat_Hold"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Mat_Hold - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Mat_Hold: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
