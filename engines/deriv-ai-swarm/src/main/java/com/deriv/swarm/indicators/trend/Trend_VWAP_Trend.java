...
public class Trend_VWAP_Trend implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend VWAP_Trend"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend VWAP_Trend - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend VWAP_Trend: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
