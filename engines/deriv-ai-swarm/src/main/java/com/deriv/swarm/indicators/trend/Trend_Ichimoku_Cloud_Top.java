...
public class Trend_Ichimoku_Cloud_Top implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Ichimoku_Cloud_Top"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Ichimoku_Cloud_Top - trend indicator with period 52"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Ichimoku_Cloud_Top: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
