...
public class Fibonacci_Channel_Mid implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Channel_Mid"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Channel_Mid - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Channel_Mid: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
