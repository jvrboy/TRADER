...
public class Momentum_Pct_Change_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Pct_Change_50"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Pct_Change_50 - momentum indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Pct_Change_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
