...
public class Momentum_Schaff_Trend_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Schaff_Trend_10"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Schaff_Trend_10 - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Schaff_Trend_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
