...
public class Pattern_Bullish_Harami implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bullish_Harami"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bullish_Harami - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bullish_Harami: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
