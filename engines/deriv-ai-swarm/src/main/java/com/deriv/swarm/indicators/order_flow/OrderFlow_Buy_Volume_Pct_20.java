...
public class OrderFlow_Buy_Volume_Pct_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Buy_Volume_Pct_20"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Buy_Volume_Pct_20 - order_flow indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Buy_Volume_Pct_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
