...
public class Volatility_Chande_Kroll_Stop_Short implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Chande_Kroll_Stop_Short"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Chande_Kroll_Stop_Short - volatility indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Chande_Kroll_Stop_Short: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
