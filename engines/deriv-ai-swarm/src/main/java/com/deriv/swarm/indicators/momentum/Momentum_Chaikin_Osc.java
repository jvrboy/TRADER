...
public class Momentum_Chaikin_Osc implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Chaikin_Osc"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Chaikin_Osc - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Chaikin_Osc: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
