...
public class Momentum_Elder_Bull_Bear_13 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Elder_Bull_Bear_13"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Elder_Bull_Bear_13 - momentum indicator with period 13"; }

    @Override
    public int getMinCandles() { return 13; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(13, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Elder_Bull_Bear_13: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
