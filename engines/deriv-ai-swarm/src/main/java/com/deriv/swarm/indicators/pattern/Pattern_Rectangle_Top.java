...
public class Pattern_Rectangle_Top implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Rectangle_Top"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Rectangle_Top - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Rectangle_Top: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
