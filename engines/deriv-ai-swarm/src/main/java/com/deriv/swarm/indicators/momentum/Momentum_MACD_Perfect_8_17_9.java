...
public class Momentum_MACD_Perfect_8_17_9 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MACD_Perfect_8_17_9"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MACD_Perfect_8_17_9 - momentum indicator with period 17"; }

    @Override
    public int getMinCandles() { return 17; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MACD_Perfect_8_17_9: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
