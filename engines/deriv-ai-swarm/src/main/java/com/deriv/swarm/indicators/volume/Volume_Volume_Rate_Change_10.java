...
public class Volume_Volume_Rate_Change_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Rate_Change_10"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Rate_Change_10 - volume indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Rate_Change_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
