...
public class Pattern_Below_S1 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Below_S1"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Below_S1 - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Below_S1: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
