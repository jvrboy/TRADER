...
public class Fibonacci_Fan_0 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Fan_0"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Fan_0 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Fan_0: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
