...
public class Pattern_Thrusting implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Thrusting"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Thrusting - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Thrusting: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
