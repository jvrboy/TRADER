...
public class Momentum_Momentum_Composite_Short implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Momentum_Composite_Short"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Momentum_Composite_Short - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Momentum_Composite_Short: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
