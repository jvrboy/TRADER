...
public class Custom_Lyapunov_Exponent implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Lyapunov_Exponent"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Lyapunov_Exponent - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Lyapunov_Exponent: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
