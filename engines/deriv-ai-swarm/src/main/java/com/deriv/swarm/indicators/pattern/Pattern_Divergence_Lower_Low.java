...
public class Pattern_Divergence_Lower_Low implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Divergence_Lower_Low"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Divergence_Lower_Low - pattern indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Divergence_Lower_Low: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
