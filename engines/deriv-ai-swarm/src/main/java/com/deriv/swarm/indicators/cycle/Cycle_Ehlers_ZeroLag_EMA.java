...
public class Cycle_Ehlers_ZeroLag_EMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Ehlers_ZeroLag_EMA"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Ehlers_ZeroLag_EMA - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Ehlers_ZeroLag_EMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
