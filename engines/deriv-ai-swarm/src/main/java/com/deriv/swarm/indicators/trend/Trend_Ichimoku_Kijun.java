...
public class Trend_Ichimoku_Kijun implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Ichimoku_Kijun"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Ichimoku_Kijun - trend indicator with period 26"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Ichimoku_Kijun: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
