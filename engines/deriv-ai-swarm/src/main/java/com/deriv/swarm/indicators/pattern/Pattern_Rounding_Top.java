...
public class Pattern_Rounding_Top implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Rounding_Top"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Rounding_Top - pattern indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Rounding_Top: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
