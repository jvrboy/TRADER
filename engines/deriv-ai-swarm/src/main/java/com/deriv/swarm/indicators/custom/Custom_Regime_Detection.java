...
public class Custom_Regime_Detection implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Regime_Detection"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Regime_Detection - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Regime_Detection: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
