...
public class Momentum_Elder_Ray_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Elder_Ray_Bull"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Elder_Ray_Bull - momentum indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Elder_Ray_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
