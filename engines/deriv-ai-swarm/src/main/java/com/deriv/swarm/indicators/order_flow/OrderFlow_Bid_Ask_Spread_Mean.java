...
public class OrderFlow_Bid_Ask_Spread_Mean implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Bid_Ask_Spread_Mean"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Bid_Ask_Spread_Mean - order_flow indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Bid_Ask_Spread_Mean: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
