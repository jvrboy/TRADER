...
public class SR_Tom_DeMark_Predict_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Tom_DeMark_Predict_2"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Tom_DeMark_Predict_2 - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 1);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Tom_DeMark_Predict_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
