...
public class Stat_Skewness_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Skewness_10"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Skewness_10 - statistical indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double std = IndicatorMath.stddev(closes, Math.min(10, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Skewness_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
