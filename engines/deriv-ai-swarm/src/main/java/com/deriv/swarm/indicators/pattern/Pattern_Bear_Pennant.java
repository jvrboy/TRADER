...
public class Pattern_Bear_Pennant implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bear_Pennant"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bear_Pennant - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bear_Pennant: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
