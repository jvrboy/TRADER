...
public class Volume_VWMA_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume VWMA_10"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume VWMA_10 - volume indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.wma(closes, 10);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume VWMA_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
