...
public class Volatility_Volatility_Regime_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Volatility_Regime_Bear"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Volatility_Regime_Bear - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Volatility_Regime_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
