...
public class Momentum_Stochastic_RSI_D implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Stochastic_RSI_D"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Stochastic_RSI_D - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Stochastic_RSI_D: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
