...
public class MarketProfile_C_Development_Area implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile C_Development_Area"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile C_Development_Area - market_profile indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile C_Development_Area: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
