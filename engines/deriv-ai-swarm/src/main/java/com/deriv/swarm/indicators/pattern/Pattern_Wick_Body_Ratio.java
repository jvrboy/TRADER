...
public class Pattern_Wick_Body_Ratio implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Wick_Body_Ratio"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Wick_Body_Ratio - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Wick_Body_Ratio: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
