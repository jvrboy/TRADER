...
public class Pattern_Diamond_Bottom implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Diamond_Bottom"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Diamond_Bottom - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Diamond_Bottom: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
