...
public class SR_S_R_Bounce_Detection implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R S_R_Bounce_Detection"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R S_R_Bounce_Detection - support_resistance indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R S_R_Bounce_Detection: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
