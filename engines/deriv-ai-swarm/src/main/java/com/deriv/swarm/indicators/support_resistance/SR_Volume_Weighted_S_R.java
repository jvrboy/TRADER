...
public class SR_Volume_Weighted_S_R implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Volume_Weighted_S_R"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Volume_Weighted_S_R - support_resistance indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Volume_Weighted_S_R: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
