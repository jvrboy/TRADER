...
public class Trend_ROC_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend ROC_50"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend ROC_50 - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend ROC_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
