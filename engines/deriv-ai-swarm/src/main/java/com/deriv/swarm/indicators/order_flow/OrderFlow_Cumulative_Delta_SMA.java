...
public class OrderFlow_Cumulative_Delta_SMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Cumulative_Delta_SMA"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Cumulative_Delta_SMA - order_flow indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Cumulative_Delta_SMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
