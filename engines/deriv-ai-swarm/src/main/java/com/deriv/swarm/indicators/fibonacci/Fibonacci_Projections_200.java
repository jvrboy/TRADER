...
public class Fibonacci_Projections_200 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Projections_200"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Projections_200 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Projections_200: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
