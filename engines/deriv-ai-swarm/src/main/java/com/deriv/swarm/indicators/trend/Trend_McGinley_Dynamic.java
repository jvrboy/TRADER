...
public class Trend_McGinley_Dynamic implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend McGinley_Dynamic"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend McGinley_Dynamic - trend indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend McGinley_Dynamic: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
