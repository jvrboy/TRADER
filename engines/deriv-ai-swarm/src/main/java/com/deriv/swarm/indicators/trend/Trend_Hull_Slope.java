...
public class Trend_Hull_Slope implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Hull_Slope"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Hull_Slope - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Hull_Slope: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
