...
public class Volume_Demand_Index implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Demand_Index"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Demand_Index - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Demand_Index: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
