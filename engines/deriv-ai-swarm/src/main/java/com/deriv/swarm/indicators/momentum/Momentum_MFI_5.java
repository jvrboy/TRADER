...
public class Momentum_MFI_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MFI_5"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MFI_5 - momentum indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MFI_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
