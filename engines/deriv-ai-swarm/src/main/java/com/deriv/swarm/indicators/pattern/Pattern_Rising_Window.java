...
public class Pattern_Rising_Window implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Rising_Window"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Rising_Window - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Rising_Window: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
