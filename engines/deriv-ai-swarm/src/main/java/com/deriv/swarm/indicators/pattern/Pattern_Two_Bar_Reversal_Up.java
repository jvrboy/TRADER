...
public class Pattern_Two_Bar_Reversal_Up implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Two_Bar_Reversal_Up"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Two_Bar_Reversal_Up - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Two_Bar_Reversal_Up: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
