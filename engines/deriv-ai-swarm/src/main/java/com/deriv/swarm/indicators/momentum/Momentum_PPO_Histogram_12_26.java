...
public class Momentum_PPO_Histogram_12_26 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum PPO_Histogram_12_26"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum PPO_Histogram_12_26 - momentum indicator with period 26"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(26, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum PPO_Histogram_12_26: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
