...
public class Pattern_Large_Bull_Candle implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Large_Bull_Candle"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Large_Bull_Candle - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Large_Bull_Candle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
