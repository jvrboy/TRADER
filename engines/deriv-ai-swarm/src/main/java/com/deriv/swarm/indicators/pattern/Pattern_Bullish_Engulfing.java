...
public class Pattern_Bullish_Engulfing implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bullish_Engulfing"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bullish_Engulfing - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bullish_Engulfing: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
