...
public class Momentum_CCI_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum CCI_50"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum CCI_50 - momentum indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum CCI_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
