...
public class OrderFlow_Iceberg_Detection implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Iceberg_Detection"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Iceberg_Detection - order_flow indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Iceberg_Detection: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
