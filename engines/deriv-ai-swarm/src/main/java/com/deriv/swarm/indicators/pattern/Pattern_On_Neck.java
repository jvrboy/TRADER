...
public class Pattern_On_Neck implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern On_Neck"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern On_Neck - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern On_Neck: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
