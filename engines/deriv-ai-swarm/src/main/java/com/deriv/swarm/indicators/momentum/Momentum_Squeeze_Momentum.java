...
public class Momentum_Squeeze_Momentum implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Squeeze_Momentum"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Squeeze_Momentum - momentum indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Squeeze_Momentum: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
