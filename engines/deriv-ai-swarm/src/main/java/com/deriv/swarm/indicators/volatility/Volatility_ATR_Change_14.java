...
public class Volatility_ATR_Change_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility ATR_Change_14"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility ATR_Change_14 - volatility indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility ATR_Change_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
