...
public class Stat_Max_Drawdown_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Max_Drawdown_50"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Max_Drawdown_50 - statistical indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double std = IndicatorMath.stddev(closes, Math.min(50, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Max_Drawdown_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
