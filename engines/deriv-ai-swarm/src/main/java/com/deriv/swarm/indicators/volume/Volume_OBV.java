...
public class Volume_OBV implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume OBV"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume OBV - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume OBV: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
