...
public class Momentum_Fisher_Transform implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Fisher_Transform"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Fisher_Transform - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Fisher_Transform: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
