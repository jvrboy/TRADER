...
public class Custom_Fractal_Dimension implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Fractal_Dimension"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Fractal_Dimension - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Fractal_Dimension: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
