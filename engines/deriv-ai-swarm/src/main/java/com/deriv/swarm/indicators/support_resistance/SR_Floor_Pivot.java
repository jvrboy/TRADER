...
public class SR_Floor_Pivot implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Floor_Pivot"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Floor_Pivot - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Floor_Pivot: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
