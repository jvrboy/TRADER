...
public class Pattern_Bearish_Engulfing implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bearish_Engulfing"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bearish_Engulfing - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bearish_Engulfing: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
