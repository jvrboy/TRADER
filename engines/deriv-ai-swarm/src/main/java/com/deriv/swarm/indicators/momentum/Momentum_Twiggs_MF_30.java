...
public class Momentum_Twiggs_MF_30 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Twiggs_MF_30"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Twiggs_MF_30 - momentum indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Twiggs_MF_30: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
