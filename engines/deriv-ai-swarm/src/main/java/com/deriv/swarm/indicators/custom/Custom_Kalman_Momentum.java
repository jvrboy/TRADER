...
public class Custom_Kalman_Momentum implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Kalman_Momentum"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Kalman_Momentum - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Kalman_Momentum: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
