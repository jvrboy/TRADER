...
public class Pattern_Double_Bottom implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Double_Bottom"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Double_Bottom - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Double_Bottom: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
