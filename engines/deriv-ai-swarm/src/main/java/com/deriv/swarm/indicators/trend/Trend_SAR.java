...
public class Trend_SAR implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SAR"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SAR - trend indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SAR: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
