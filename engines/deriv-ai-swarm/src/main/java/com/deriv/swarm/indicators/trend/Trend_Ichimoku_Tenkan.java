...
public class Trend_Ichimoku_Tenkan implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Ichimoku_Tenkan"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Ichimoku_Tenkan - trend indicator with period 9"; }

    @Override
    public int getMinCandles() { return 9; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(9, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Ichimoku_Tenkan: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
