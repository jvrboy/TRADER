...
public class Pattern_Hanging_Man implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Hanging_Man"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Hanging_Man - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Hanging_Man: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
