...
public class Momentum_Reg_Slope_Momentum_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Reg_Slope_Momentum_5"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Reg_Slope_Momentum_5 - momentum indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Reg_Slope_Momentum_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
