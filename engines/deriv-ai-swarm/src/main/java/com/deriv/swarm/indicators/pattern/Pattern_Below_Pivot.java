...
public class Pattern_Below_Pivot implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Below_Pivot"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Below_Pivot - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Below_Pivot: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
