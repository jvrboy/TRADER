...
public class Volatility_KC_Lower_20_1_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility KC_Lower_20_1_5"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility KC_Lower_20_1_5 - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility KC_Lower_20_1_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
