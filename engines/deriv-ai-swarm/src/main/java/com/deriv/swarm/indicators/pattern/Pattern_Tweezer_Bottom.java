...
public class Pattern_Tweezer_Bottom implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Tweezer_Bottom"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Tweezer_Bottom - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Tweezer_Bottom: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
