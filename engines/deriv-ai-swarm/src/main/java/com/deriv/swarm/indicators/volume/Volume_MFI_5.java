...
public class Volume_MFI_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume MFI_5"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume MFI_5 - volume indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume MFI_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
