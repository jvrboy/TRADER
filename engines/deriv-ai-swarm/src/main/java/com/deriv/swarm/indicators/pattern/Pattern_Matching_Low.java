...
public class Pattern_Matching_Low implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Matching_Low"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Matching_Low - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Matching_Low: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
