...
public class Custom_XGBoost_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom XGBoost_Signal"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom XGBoost_Signal - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom XGBoost_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
