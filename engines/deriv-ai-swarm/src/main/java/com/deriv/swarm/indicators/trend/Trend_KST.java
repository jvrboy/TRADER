...
public class Trend_KST implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend KST"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend KST - trend indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend KST: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
