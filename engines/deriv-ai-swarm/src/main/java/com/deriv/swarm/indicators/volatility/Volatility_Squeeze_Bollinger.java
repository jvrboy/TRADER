...
public class Volatility_Squeeze_Bollinger implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Squeeze_Bollinger"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Squeeze_Bollinger - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Squeeze_Bollinger: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
