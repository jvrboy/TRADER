...
public class Custom_Market_Phase_Detector implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Market_Phase_Detector"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Market_Phase_Detector - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Market_Phase_Detector: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
