...
public class Pattern_In_Neck implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern In_Neck"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern In_Neck - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern In_Neck: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
