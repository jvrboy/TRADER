...
public class MarketProfile_Non_Overlap_Days implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Non_Overlap_Days"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Non_Overlap_Days - market_profile indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Non_Overlap_Days: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
