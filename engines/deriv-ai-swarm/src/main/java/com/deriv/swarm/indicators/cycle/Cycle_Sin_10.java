...
public class Cycle_Sin_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Sin_10"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Sin_10 - cycle indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Sin_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
