...
public class Pattern_Three_Bar_Reversal_Up implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Three_Bar_Reversal_Up"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Three_Bar_Reversal_Up - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Three_Bar_Reversal_Up: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
