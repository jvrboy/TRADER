...
public class Momentum_Pct_Change_3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Pct_Change_3"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Pct_Change_3 - momentum indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Pct_Change_3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
