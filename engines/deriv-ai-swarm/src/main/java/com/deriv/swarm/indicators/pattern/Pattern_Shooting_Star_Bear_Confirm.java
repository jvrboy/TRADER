...
public class Pattern_Shooting_Star_Bear_Confirm implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Shooting_Star_Bear_Confirm"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Shooting_Star_Bear_Confirm - pattern indicator with period 4"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Shooting_Star_Bear_Confirm: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
