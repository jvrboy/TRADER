...
public class Volume_Volume_Price_Confirm implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Price_Confirm"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Price_Confirm - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Price_Confirm: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
