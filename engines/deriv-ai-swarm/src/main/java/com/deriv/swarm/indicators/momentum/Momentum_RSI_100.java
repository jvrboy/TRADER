...
public class Momentum_RSI_100 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_100"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_100 - momentum indicator with period 100"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 100);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_100: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
