...
public class Momentum_MACD_5_34_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MACD_5_34_5"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MACD_5_34_5 - momentum indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MACD_5_34_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
