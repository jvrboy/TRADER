...
public class Trend_TEMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend TEMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend TEMA - trend indicator with period 100"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 100);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend TEMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
