...
public class MarketProfile_Order_Block_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Order_Block_Bear"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Order_Block_Bear - market_profile indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Order_Block_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
