...
public class Volume_NVI implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume NVI"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume NVI - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume NVI: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
