...
public class Pattern_Downside_Tasuki_Gap implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Downside_Tasuki_Gap"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Downside_Tasuki_Gap - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Downside_Tasuki_Gap: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
