...
public class Pattern_Dragonfly_Doji implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Dragonfly_Doji"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Dragonfly_Doji - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Dragonfly_Doji: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
