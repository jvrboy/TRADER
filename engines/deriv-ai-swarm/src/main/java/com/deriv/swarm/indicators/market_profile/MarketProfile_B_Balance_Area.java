...
public class MarketProfile_B_Balance_Area implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile B_Balance_Area"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile B_Balance_Area - market_profile indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile B_Balance_Area: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
