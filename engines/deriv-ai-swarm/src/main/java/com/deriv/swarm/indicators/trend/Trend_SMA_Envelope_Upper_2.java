...
public class Trend_SMA_Envelope_Upper_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SMA_Envelope_Upper_2"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SMA_Envelope_Upper_2 - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SMA_Envelope_Upper_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
