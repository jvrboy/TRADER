...
public class Pivot_Weekly_S1 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Weekly_S1"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Weekly_S1 - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Weekly_S1: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
