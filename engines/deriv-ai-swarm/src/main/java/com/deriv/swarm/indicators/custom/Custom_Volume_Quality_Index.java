...
public class Custom_Volume_Quality_Index implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Volume_Quality_Index"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Volume_Quality_Index - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Volume_Quality_Index: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
