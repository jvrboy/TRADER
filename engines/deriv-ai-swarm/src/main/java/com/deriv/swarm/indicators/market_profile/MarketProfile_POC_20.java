...
public class MarketProfile_POC_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile POC_20"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile POC_20 - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile POC_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
