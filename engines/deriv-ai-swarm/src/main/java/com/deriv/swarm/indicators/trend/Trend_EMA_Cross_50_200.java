...
public class Trend_EMA_Cross_50_200 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend EMA_Cross_50_200"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend EMA_Cross_50_200 - trend indicator with period 200"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 200);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend EMA_Cross_50_200: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
