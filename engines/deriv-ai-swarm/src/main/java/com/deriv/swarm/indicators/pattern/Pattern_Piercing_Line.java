...
public class Pattern_Piercing_Line implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Piercing_Line"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Piercing_Line - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Piercing_Line: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
