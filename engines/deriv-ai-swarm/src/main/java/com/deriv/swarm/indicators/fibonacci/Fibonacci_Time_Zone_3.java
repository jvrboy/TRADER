...
public class Fibonacci_Time_Zone_3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Time_Zone_3"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Time_Zone_3 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Time_Zone_3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
