...
public class Fibonacci_Arc_500 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Arc_500"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Arc_500 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Arc_500: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
