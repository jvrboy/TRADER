...
public class Pattern_MFI_Divergence_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern MFI_Divergence_Bull"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern MFI_Divergence_Bull - pattern indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern MFI_Divergence_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
