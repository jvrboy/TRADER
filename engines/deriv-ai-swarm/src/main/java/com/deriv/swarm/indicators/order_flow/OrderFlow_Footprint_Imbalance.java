...
public class OrderFlow_Footprint_Imbalance implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Footprint_Imbalance"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Footprint_Imbalance - order_flow indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Footprint_Imbalance: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
