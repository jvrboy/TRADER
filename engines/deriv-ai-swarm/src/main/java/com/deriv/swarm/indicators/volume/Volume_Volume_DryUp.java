...
public class Volume_Volume_DryUp implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_DryUp"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_DryUp - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_DryUp: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
