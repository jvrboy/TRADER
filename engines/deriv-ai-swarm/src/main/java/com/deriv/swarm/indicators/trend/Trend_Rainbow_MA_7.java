...
public class Trend_Rainbow_MA_7 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Rainbow_MA_7"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Rainbow_MA_7 - trend indicator with period 7"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Rainbow_MA_7: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
