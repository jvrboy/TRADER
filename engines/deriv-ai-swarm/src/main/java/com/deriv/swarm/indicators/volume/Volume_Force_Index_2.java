...
public class Volume_Force_Index_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Force_Index_2"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Force_Index_2 - volume indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Force_Index_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
