...
public class Trend_EMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend EMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend EMA - trend indicator with period 500"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 500);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend EMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
