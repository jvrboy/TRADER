...
public class Pattern_Falling_Wedge implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Falling_Wedge"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Falling_Wedge - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Falling_Wedge: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
