...
public class Pattern_Above_R2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Above_R2"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Above_R2 - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Above_R2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
