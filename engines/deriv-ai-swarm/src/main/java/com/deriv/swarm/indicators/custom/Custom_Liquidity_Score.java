...
public class Custom_Liquidity_Score implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Liquidity_Score"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Liquidity_Score - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Liquidity_Score: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
