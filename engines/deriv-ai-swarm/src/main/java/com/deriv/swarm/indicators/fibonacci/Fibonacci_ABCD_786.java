...
public class Fibonacci_ABCD_786 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci ABCD_786"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci ABCD_786 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci ABCD_786: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
