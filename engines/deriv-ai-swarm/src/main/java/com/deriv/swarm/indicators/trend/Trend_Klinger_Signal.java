...
public class Trend_Klinger_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Klinger_Signal"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Klinger_Signal - trend indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Klinger_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
