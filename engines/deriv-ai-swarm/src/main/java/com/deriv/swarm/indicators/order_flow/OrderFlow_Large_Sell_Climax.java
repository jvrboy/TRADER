...
public class OrderFlow_Large_Sell_Climax implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Large_Sell_Climax"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Large_Sell_Climax - order_flow indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Large_Sell_Climax: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
