...
public class Volatility_EMA_Volatility_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility EMA_Volatility_20"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility EMA_Volatility_20 - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 20);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility EMA_Volatility_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
