...
public class Pattern_Advance_Block implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Advance_Block"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Advance_Block - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Advance_Block: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
