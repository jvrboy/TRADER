...
public class Trend_LR_Slope_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend LR_Slope_10"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend LR_Slope_10 - trend indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend LR_Slope_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
