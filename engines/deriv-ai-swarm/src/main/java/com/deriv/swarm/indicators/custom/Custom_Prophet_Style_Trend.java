...
public class Custom_Prophet_Style_Trend implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Prophet_Style_Trend"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Prophet_Style_Trend - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Prophet_Style_Trend: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
