...
public class Volume_Negative_Volume implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Negative_Volume"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Negative_Volume - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Negative_Volume: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
