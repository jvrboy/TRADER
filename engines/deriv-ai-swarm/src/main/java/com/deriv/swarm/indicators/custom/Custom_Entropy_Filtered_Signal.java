...
public class Custom_Entropy_Filtered_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Entropy_Filtered_Signal"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Entropy_Filtered_Signal - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Entropy_Filtered_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
