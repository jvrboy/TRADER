...
public class Momentum_RSI_30 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_30"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_30 - momentum indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 30);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_30: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
