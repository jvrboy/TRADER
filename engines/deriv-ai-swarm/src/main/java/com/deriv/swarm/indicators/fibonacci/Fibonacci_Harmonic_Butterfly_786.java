...
public class Fibonacci_Harmonic_Butterfly_786 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Harmonic_Butterfly_786"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Harmonic_Butterfly_786 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Harmonic_Butterfly_786: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
