...
public class Pattern_Falling_Window implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Falling_Window"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Falling_Window - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Falling_Window: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
