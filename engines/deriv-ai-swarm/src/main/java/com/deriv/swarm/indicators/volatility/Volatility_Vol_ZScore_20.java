...
public class Volatility_Vol_ZScore_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Vol_ZScore_20"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Vol_ZScore_20 - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Vol_ZScore_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
