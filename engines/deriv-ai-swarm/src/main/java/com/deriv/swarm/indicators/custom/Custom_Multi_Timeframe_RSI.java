...
public class Custom_Multi_Timeframe_RSI implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Multi_Timeframe_RSI"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Multi_Timeframe_RSI - custom indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Multi_Timeframe_RSI: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
