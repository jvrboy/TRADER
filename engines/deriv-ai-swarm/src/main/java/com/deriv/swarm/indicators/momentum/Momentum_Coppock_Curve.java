...
public class Momentum_Coppock_Curve implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Coppock_Curve"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Coppock_Curve - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Coppock_Curve: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
