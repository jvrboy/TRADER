...
public class Fibonacci_Golden_Ratio_Measure implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Golden_Ratio_Measure"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Golden_Ratio_Measure - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Golden_Ratio_Measure: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
