...
public class Trend_CMO_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend CMO_14"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend CMO_14 - trend indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend CMO_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
