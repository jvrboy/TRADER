...
public class Volume_Price_Volume_Trend implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Price_Volume_Trend"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Price_Volume_Trend - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Price_Volume_Trend: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
