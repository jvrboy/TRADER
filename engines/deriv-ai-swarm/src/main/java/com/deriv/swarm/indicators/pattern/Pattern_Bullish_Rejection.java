...
public class Pattern_Bullish_Rejection implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bullish_Rejection"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bullish_Rejection - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bullish_Rejection: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
