...
public class Custom_Trend_Strength_Index implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Trend_Strength_Index"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Trend_Strength_Index - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Trend_Strength_Index: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
