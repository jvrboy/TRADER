...
public class Cycle_Sine_Wave_Cross implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Sine_Wave_Cross"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Sine_Wave_Cross - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Sine_Wave_Cross: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
