...
public class Cycle_Seasonal_Component_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Seasonal_Component_5"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Seasonal_Component_5 - cycle indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Seasonal_Component_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
