...
public class Momentum_RSI_21 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_21"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_21 - momentum indicator with period 21"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_21: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
