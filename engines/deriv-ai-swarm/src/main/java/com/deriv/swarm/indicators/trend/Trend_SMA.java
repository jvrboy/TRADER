...
public class Trend_SMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SMA - trend indicator with period 500"; }

    @Override
    public int getMinCandles() { return 500; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 500);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
