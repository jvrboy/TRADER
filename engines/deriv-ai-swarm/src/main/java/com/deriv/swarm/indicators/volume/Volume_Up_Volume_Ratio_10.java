...
public class Volume_Up_Volume_Ratio_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Up_Volume_Ratio_10"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Up_Volume_Ratio_10 - volume indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Up_Volume_Ratio_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
