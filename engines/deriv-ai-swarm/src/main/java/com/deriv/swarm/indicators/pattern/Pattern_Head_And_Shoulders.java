...
public class Pattern_Head_And_Shoulders implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Head_And_Shoulders"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Head_And_Shoulders - pattern indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Head_And_Shoulders: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
