...
public class Momentum_MACD_Zero_Lag implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MACD_Zero_Lag"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MACD_Zero_Lag - momentum indicator with period 26"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MACD_Zero_Lag: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
