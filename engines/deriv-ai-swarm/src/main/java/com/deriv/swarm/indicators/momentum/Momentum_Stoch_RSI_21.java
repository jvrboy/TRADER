...
public class Momentum_Stoch_RSI_21 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Stoch_RSI_21"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Stoch_RSI_21 - momentum indicator with period 21"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 21);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Stoch_RSI_21: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
