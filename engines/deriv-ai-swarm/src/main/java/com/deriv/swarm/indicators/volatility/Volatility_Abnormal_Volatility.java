...
public class Volatility_Abnormal_Volatility implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Abnormal_Volatility"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Abnormal_Volatility - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Abnormal_Volatility: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
