...
public class Cycle_Fourier_First_Harmonic implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Fourier_First_Harmonic"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Fourier_First_Harmonic - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Fourier_First_Harmonic: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
