...
public class Trend_Rainbow_MA_8 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Rainbow_MA_8"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Rainbow_MA_8 - trend indicator with period 8"; }

    @Override
    public int getMinCandles() { return 8; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(8, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Rainbow_MA_8: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
