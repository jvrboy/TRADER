...
public class Volatility_True_Range_SMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility True_Range_SMA"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility True_Range_SMA - volatility indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility True_Range_SMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
