...
public class Fibonacci_Channel_Upper implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Channel_Upper"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Channel_Upper - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Channel_Upper: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
