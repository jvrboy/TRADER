...
public class Fibonacci_Harmonic_Gartley_618 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Harmonic_Gartley_618"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Harmonic_Gartley_618 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Harmonic_Gartley_618: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
