...
public class Volatility_KC_Lower_20_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility KC_Lower_20_2"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility KC_Lower_20_2 - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility KC_Lower_20_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
