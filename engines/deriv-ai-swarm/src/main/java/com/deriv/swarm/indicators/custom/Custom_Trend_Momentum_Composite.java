...
public class Custom_Trend_Momentum_Composite implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Trend_Momentum_Composite"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Trend_Momentum_Composite - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Trend_Momentum_Composite: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
