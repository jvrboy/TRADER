...
public class Momentum_Price_vs_SMA_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Price_vs_SMA_50"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Price_vs_SMA_50 - momentum indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 50);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Price_vs_SMA_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
