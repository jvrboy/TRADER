...
public class MarketProfile_Single_Print_Distribution implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Single_Print_Distribution"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Single_Print_Distribution - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double high = IndicatorMath.max(closes, Math.min(20, closes.size()));
        double low = IndicatorMath.min(closes, Math.min(20, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Single_Print_Distribution: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
