...
public class Momentum_Twiggs_MF_21 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Twiggs_MF_21"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Twiggs_MF_21 - momentum indicator with period 21"; }

    @Override
    public int getMinCandles() { return 21; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(21, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Twiggs_MF_21: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
