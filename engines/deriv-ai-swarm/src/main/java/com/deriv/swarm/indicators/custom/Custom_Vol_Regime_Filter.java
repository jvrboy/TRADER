...
public class Custom_Vol_Regime_Filter implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Vol_Regime_Filter"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Vol_Regime_Filter - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Vol_Regime_Filter: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
