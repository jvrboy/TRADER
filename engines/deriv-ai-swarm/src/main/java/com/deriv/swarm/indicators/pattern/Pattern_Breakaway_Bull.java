...
public class Pattern_Breakaway_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Breakaway_Bull"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Breakaway_Bull - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Breakaway_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
