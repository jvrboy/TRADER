...
public class Pattern_Evening_Star implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Evening_Star"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Evening_Star - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Evening_Star: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
