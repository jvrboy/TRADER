...
public class Pattern_Inside_Bar_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Inside_Bar_Bull"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Inside_Bar_Bull - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Inside_Bar_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
