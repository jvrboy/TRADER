...
public class Trend_KST_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend KST_Signal"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend KST_Signal - trend indicator with period 9"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend KST_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
