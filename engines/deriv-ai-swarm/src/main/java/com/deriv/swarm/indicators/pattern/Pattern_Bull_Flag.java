...
public class Pattern_Bull_Flag implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bull_Flag"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bull_Flag - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bull_Flag: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
