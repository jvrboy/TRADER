...
public class SR_S_R_High_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R S_R_High_50"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R S_R_High_50 - support_resistance indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R S_R_High_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
