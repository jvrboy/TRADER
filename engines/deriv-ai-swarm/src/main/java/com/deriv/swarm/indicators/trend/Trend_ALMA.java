...
public class Trend_ALMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend ALMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend ALMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend ALMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
