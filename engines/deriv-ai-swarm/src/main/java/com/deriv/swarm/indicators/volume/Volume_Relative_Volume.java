...
public class Volume_Relative_Volume implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Relative_Volume"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Relative_Volume - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Relative_Volume: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
