...
public class Volatility_Chande_Kroll_Stop_Long implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Chande_Kroll_Stop_Long"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Chande_Kroll_Stop_Long - volatility indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Chande_Kroll_Stop_Long: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
