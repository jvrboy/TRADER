...
public class Trend_ZLEMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend ZLEMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend ZLEMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend ZLEMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
