...
public class Volatility_Squeeze_Onset implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Squeeze_Onset"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Squeeze_Onset - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Squeeze_Onset: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
