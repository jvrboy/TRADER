...
public class Momentum_RSI_28 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_28"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_28 - momentum indicator with period 28"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 28);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_28: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
