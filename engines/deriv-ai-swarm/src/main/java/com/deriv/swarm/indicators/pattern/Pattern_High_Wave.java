...
public class Pattern_High_Wave implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern High_Wave"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern High_Wave - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern High_Wave: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
