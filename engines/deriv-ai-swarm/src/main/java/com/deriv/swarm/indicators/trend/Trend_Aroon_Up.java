...
public class Trend_Aroon_Up implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Aroon_Up"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Aroon_Up - trend indicator with period 25"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Aroon_Up: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
