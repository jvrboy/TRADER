...
public class SR_Trendline_Support implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Trendline_Support"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Trendline_Support - support_resistance indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Trendline_Support: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
