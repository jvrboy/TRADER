...
public class Pattern_MACD_Divergence_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern MACD_Divergence_Bear"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern MACD_Divergence_Bear - pattern indicator with period 26"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern MACD_Divergence_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
