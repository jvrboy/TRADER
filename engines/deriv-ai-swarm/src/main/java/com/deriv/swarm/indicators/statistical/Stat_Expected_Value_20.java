...
public class Stat_Expected_Value_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Expected_Value_20"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Expected_Value_20 - statistical indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Expected_Value_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
