...
public class Momentum_TSI_13_7 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum TSI_13_7"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum TSI_13_7 - momentum indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum TSI_13_7: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
