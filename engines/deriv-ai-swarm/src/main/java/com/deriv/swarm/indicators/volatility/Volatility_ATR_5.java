...
public class Volatility_ATR_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility ATR_5"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility ATR_5 - volatility indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility ATR_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
