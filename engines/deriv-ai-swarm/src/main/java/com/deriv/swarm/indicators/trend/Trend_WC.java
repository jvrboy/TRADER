...
public class Trend_WC implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend WC"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend WC - trend indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend WC: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
