...
public class MarketProfile_Extended_Range_Days implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Extended_Range_Days"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Extended_Range_Days - market_profile indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double high = IndicatorMath.max(closes, Math.min(5, closes.size()));
        double low = IndicatorMath.min(closes, Math.min(5, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Extended_Range_Days: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
