...
public class Fibonacci_Extension_2618 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Extension_2618"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Extension_2618 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Extension_2618: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
