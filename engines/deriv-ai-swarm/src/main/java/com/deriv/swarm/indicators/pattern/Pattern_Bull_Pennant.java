...
public class Pattern_Bull_Pennant implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bull_Pennant"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bull_Pennant - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bull_Pennant: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
