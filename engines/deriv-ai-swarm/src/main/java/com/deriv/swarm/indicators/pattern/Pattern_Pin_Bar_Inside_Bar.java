...
public class Pattern_Pin_Bar_Inside_Bar implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Pin_Bar_Inside_Bar"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Pin_Bar_Inside_Bar - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Pin_Bar_Inside_Bar: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
