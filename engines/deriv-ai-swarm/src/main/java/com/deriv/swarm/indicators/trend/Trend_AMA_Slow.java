...
public class Trend_AMA_Slow implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend AMA_Slow"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend AMA_Slow - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend AMA_Slow: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
