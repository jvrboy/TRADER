...
public class Custom_GARCH_Forecast implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom GARCH_Forecast"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom GARCH_Forecast - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom GARCH_Forecast: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
