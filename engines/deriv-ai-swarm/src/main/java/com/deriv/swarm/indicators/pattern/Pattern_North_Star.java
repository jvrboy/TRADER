...
public class Pattern_North_Star implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern North_Star"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern North_Star - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern North_Star: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
