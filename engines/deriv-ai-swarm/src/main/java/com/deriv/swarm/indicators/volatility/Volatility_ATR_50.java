...
public class Volatility_ATR_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility ATR_50"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility ATR_50 - volatility indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility ATR_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
