...
public class Pattern_Dark_Cloud_Cover implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Dark_Cloud_Cover"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Dark_Cloud_Cover - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Dark_Cloud_Cover: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
