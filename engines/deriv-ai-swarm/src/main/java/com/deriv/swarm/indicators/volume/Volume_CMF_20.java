...
public class Volume_CMF_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume CMF_20"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume CMF_20 - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume CMF_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
