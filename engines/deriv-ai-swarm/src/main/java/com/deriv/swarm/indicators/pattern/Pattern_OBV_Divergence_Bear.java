...
public class Pattern_OBV_Divergence_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern OBV_Divergence_Bear"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern OBV_Divergence_Bear - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern OBV_Divergence_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
