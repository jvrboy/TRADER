...
public class SR_ATR_Based_Support_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R ATR_Based_Support_14"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R ATR_Based_Support_14 - support_resistance indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R ATR_Based_Support_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
