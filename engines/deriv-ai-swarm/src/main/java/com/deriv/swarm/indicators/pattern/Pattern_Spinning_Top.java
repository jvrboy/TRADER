...
public class Pattern_Spinning_Top implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Spinning_Top"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Spinning_Top - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Spinning_Top: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
