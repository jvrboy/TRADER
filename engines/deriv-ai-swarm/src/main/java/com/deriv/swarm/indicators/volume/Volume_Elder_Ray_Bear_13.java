...
public class Volume_Elder_Ray_Bear_13 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Elder_Ray_Bear_13"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Elder_Ray_Bear_13 - volume indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Elder_Ray_Bear_13: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
