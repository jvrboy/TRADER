...
public class Volume_EOM_SMA_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume EOM_SMA_10"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume EOM_SMA_10 - volume indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume EOM_SMA_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
