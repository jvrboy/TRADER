...
public class Trend_LR_Slope_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend LR_Slope_50"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend LR_Slope_50 - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend LR_Slope_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
