...
public class Trend_Mass_Index_9_25 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Mass_Index_9_25"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Mass_Index_9_25 - trend indicator with period 25"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Mass_Index_9_25: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
