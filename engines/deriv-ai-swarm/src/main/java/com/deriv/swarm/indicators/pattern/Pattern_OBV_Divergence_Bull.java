...
public class Pattern_OBV_Divergence_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern OBV_Divergence_Bull"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern OBV_Divergence_Bull - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern OBV_Divergence_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
