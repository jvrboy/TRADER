...
public class Trend_EMA_Envelope_Lower_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend EMA_Envelope_Lower_2"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend EMA_Envelope_Lower_2 - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend EMA_Envelope_Lower_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
