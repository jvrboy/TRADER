...
public class Momentum_Stochastic_RSI_K implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Stochastic_RSI_K"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Stochastic_RSI_K - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Stochastic_RSI_K: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
