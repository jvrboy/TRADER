...
public class Momentum_CCI_Overbought_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum CCI_Overbought_20"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum CCI_Overbought_20 - momentum indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum CCI_Overbought_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
