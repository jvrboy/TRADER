...
public class Pattern_Tasuki_Gap_Up implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Tasuki_Gap_Up"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Tasuki_Gap_Up - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Tasuki_Gap_Up: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
