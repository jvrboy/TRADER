...
public class Stat_Correlation_Close_Volume_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Correlation_Close_Volume_20"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Correlation_Close_Volume_20 - statistical indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Correlation_Close_Volume_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
