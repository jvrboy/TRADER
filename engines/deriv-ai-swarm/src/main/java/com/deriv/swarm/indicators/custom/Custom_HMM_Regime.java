...
public class Custom_HMM_Regime implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom HMM_Regime"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom HMM_Regime - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom HMM_Regime: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
