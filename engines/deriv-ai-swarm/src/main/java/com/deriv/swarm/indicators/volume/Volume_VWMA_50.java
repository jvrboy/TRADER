...
public class Volume_VWMA_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume VWMA_50"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume VWMA_50 - volume indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.wma(closes, 50);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume VWMA_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
