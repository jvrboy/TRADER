...
public class Trend_TRIX_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend TRIX_10"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend TRIX_10 - trend indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend TRIX_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
