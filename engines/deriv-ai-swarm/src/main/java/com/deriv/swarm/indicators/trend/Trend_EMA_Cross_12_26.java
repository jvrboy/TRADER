...
public class Trend_EMA_Cross_12_26 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend EMA_Cross_12_26"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend EMA_Cross_12_26 - trend indicator with period 26"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend EMA_Cross_12_26: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
