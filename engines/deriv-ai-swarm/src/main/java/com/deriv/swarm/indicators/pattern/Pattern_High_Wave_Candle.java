...
public class Pattern_High_Wave_Candle implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern High_Wave_Candle"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern High_Wave_Candle - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern High_Wave_Candle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
