...
public class MarketProfile_Value_Area_Expansion implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Value_Area_Expansion"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Value_Area_Expansion - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Value_Area_Expansion: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
