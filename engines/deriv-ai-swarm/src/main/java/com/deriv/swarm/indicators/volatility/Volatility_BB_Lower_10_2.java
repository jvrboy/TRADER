...
public class Volatility_BB_Lower_10_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility BB_Lower_10_2"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility BB_Lower_10_2 - volatility indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility BB_Lower_10_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
