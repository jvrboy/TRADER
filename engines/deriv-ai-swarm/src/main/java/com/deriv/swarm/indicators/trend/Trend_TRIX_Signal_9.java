...
public class Trend_TRIX_Signal_9 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend TRIX_Signal_9"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend TRIX_Signal_9 - trend indicator with period 9"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend TRIX_Signal_9: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
