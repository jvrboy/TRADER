...
public class Pattern_South_Star implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern South_Star"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern South_Star - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern South_Star: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
