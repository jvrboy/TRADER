...
public class Momentum_Ease_of_Movement implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Ease_of_Movement"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Ease_of_Movement - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Ease_of_Movement: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
