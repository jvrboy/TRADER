...
public class Pattern_Three_Down_Small implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Three_Down_Small"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Three_Down_Small - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 3);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Three_Down_Small: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
