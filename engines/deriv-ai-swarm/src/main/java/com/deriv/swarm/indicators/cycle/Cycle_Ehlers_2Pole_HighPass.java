...
public class Cycle_Ehlers_2Pole_HighPass implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Ehlers_2Pole_HighPass"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Ehlers_2Pole_HighPass - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Ehlers_2Pole_HighPass: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
