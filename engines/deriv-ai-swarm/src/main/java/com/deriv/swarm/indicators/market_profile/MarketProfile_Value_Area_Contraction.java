...
public class MarketProfile_Value_Area_Contraction implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Value_Area_Contraction"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Value_Area_Contraction - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Value_Area_Contraction: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
