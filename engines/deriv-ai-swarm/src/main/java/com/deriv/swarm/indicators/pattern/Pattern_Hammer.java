...
public class Pattern_Hammer implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Hammer"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Hammer - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Hammer: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
