...
public class Momentum_RSI_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_5"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_5 - momentum indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 5);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
