...
public class Momentum_Ease_of_Movement_SMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Ease_of_Movement_SMA"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Ease_of_Movement_SMA - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 14);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Ease_of_Movement_SMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
