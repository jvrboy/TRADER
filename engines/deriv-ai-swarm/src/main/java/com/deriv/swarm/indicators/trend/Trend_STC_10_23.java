...
public class Trend_STC_10_23 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend STC_10_23"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend STC_10_23 - trend indicator with period 23"; }

    @Override
    public int getMinCandles() { return 23; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(23, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend STC_10_23: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
