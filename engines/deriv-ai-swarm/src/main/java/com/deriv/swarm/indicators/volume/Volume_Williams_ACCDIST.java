...
public class Volume_Williams_ACCDIST implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Williams_ACCDIST"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Williams_ACCDIST - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Williams_ACCDIST: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
