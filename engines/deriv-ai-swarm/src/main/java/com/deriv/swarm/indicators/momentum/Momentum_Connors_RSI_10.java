...
public class Momentum_Connors_RSI_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Connors_RSI_10"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Connors_RSI_10 - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 10);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Connors_RSI_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
