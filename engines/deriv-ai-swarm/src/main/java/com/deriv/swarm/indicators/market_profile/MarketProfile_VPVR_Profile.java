...
public class MarketProfile_VPVR_Profile implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile VPVR_Profile"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile VPVR_Profile - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile VPVR_Profile: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
