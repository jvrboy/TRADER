...
public class Trend_Rainbow_MA_6 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Rainbow_MA_6"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Rainbow_MA_6 - trend indicator with period 6"; }

    @Override
    public int getMinCandles() { return 6; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(6, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Rainbow_MA_6: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
