...
public class Momentum_Williams_AD_Rate implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Williams_AD_Rate"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Williams_AD_Rate - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Williams_AD_Rate: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
