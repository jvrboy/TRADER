...
public class Pattern_Rising_Wedge implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Rising_Wedge"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Rising_Wedge - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Rising_Wedge: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
