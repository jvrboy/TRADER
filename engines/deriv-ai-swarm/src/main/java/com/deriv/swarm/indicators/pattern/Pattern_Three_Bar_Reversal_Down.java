...
public class Pattern_Three_Bar_Reversal_Down implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Three_Bar_Reversal_Down"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Three_Bar_Reversal_Down - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Three_Bar_Reversal_Down: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
