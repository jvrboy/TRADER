...
public class Custom_Kalman_Filtered_Price implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Kalman_Filtered_Price"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Kalman_Filtered_Price - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Kalman_Filtered_Price: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
