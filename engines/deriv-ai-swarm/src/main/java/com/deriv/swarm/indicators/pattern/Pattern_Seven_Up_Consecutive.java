...
public class Pattern_Seven_Up_Consecutive implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Seven_Up_Consecutive"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Seven_Up_Consecutive - pattern indicator with period 7"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Seven_Up_Consecutive: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
