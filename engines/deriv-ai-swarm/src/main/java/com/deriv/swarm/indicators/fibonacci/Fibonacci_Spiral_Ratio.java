...
public class Fibonacci_Spiral_Ratio implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Spiral_Ratio"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Spiral_Ratio - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Spiral_Ratio: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
