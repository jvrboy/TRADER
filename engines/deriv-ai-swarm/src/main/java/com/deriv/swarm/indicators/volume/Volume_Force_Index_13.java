...
public class Volume_Force_Index_13 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Force_Index_13"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Force_Index_13 - volume indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Force_Index_13: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
