...
public class Pattern_Hammer_Bull_Confirm implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Hammer_Bull_Confirm"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Hammer_Bull_Confirm - pattern indicator with period 4"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Hammer_Bull_Confirm: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
