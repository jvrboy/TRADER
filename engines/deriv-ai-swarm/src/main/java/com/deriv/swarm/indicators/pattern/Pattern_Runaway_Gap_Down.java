...
public class Pattern_Runaway_Gap_Down implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Runaway_Gap_Down"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Runaway_Gap_Down - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Runaway_Gap_Down: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
