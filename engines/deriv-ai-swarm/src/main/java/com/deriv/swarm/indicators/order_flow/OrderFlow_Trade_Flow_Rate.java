...
public class OrderFlow_Trade_Flow_Rate implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Trade_Flow_Rate"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Trade_Flow_Rate - order_flow indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Trade_Flow_Rate: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
