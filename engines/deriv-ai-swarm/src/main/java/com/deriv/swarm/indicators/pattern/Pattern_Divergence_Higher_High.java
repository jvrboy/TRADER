...
public class Pattern_Divergence_Higher_High implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Divergence_Higher_High"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Divergence_Higher_High - pattern indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Divergence_Higher_High: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
