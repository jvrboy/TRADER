...
public class Volatility_Squeeze_State implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Squeeze_State"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Squeeze_State - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Squeeze_State: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
