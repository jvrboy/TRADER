...
public class OrderFlow_Liquidity_Consumption implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Liquidity_Consumption"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Liquidity_Consumption - order_flow indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Liquidity_Consumption: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
