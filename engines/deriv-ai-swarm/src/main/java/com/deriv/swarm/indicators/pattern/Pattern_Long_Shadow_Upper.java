...
public class Pattern_Long_Shadow_Upper implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Long_Shadow_Upper"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Long_Shadow_Upper - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Long_Shadow_Upper: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
