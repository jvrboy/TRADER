...
public class Pattern_Two_Crows implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Two_Crows"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Two_Crows - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Two_Crows: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
