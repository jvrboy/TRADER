...
public class Pattern_Inverse_Cup_Handle implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Inverse_Cup_Handle"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Inverse_Cup_Handle - pattern indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Inverse_Cup_Handle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
