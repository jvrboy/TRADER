...
public class Momentum_RSI_7 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_7"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_7 - momentum indicator with period 7"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 7);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_7: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
