...
public class Volume_OnBalance_Volatility implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume OnBalance_Volatility"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume OnBalance_Volatility - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume OnBalance_Volatility: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
