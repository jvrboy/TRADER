...
public class Pattern_Falling_Three_Methods implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Falling_Three_Methods"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Falling_Three_Methods - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Falling_Three_Methods: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
