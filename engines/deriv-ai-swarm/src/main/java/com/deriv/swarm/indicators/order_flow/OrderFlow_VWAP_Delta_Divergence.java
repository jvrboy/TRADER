...
public class OrderFlow_VWAP_Delta_Divergence implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow VWAP_Delta_Divergence"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow VWAP_Delta_Divergence - order_flow indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow VWAP_Delta_Divergence: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
