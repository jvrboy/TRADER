...
public class Custom_Clustering_Regime implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Clustering_Regime"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Clustering_Regime - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Clustering_Regime: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
