...
public class Cycle_Fourier_Trend implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Fourier_Trend"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Fourier_Trend - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Fourier_Trend: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
