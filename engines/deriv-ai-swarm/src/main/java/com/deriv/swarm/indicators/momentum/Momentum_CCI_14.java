...
public class Momentum_CCI_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum CCI_14"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum CCI_14 - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum CCI_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
