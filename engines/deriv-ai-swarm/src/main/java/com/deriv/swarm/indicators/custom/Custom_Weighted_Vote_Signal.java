...
public class Custom_Weighted_Vote_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Weighted_Vote_Signal"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Weighted_Vote_Signal - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Weighted_Vote_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
