...
public class Momentum_ADX_Momentum_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum ADX_Momentum_14"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum ADX_Momentum_14 - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum ADX_Momentum_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
