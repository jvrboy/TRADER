...
public class Pattern_Stick_Sandwich implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Stick_Sandwich"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Stick_Sandwich - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Stick_Sandwich: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
