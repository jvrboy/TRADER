...
public class Volume_Volume_Momentum_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Momentum_5"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Momentum_5 - volume indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Momentum_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
