...
public class Momentum_Disparity_EMA_12 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Disparity_EMA_12"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Disparity_EMA_12 - momentum indicator with period 12"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 12);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Disparity_EMA_12: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
