...
public class Momentum_Awesome_Oscillator implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Awesome_Oscillator"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Awesome_Oscillator - momentum indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Awesome_Oscillator: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
