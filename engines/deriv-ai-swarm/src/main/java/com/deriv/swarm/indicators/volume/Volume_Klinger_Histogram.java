...
public class Volume_Klinger_Histogram implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Klinger_Histogram"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Klinger_Histogram - volume indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Klinger_Histogram: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
