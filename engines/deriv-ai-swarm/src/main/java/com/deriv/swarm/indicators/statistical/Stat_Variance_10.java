...
public class Stat_Variance_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Variance_10"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Variance_10 - statistical indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Variance_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
