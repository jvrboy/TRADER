...
public class Volume_Volume_Profile_High implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Profile_High"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Profile_High - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Profile_High: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
