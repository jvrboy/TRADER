...
public class Pattern_Bearish_Rejection implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bearish_Rejection"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bearish_Rejection - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bearish_Rejection: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
