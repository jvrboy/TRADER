...
public class Pivot_Fib_R3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Fib_R3"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Fib_R3 - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Fib_R3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
