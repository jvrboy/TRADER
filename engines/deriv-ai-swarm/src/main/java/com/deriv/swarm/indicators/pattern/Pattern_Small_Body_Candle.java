...
public class Pattern_Small_Body_Candle implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Small_Body_Candle"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Small_Body_Candle - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 1);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Small_Body_Candle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
