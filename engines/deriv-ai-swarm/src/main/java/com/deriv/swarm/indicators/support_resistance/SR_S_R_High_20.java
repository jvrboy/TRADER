...
public class SR_S_R_High_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R S_R_High_20"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R S_R_High_20 - support_resistance indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R S_R_High_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
