...
public class Volatility_True_Range implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility True_Range"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility True_Range - volatility indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility True_Range: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
