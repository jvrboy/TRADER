...
public class Volume_Chaikin_AccDist_Slope implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Chaikin_AccDist_Slope"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Chaikin_AccDist_Slope - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Chaikin_AccDist_Slope: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
