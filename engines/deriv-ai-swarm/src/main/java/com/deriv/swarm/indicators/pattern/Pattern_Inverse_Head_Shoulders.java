...
public class Pattern_Inverse_Head_Shoulders implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Inverse_Head_Shoulders"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Inverse_Head_Shoulders - pattern indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Inverse_Head_Shoulders: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
