...
public class Volume_Supply_Demand_Ratio implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Supply_Demand_Ratio"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Supply_Demand_Ratio - volume indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Supply_Demand_Ratio: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
