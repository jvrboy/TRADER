...
public class Momentum_Force_Index_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Force_Index_2"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Force_Index_2 - momentum indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Force_Index_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
