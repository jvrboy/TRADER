...
public class MarketProfile_Buyer_Seller_Imbalance implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Buyer_Seller_Imbalance"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Buyer_Seller_Imbalance - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Buyer_Seller_Imbalance: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
