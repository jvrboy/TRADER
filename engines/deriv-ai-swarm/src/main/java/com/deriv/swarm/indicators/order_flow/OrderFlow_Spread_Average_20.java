...
public class OrderFlow_Spread_Average_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Spread_Average_20"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Spread_Average_20 - order_flow indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Spread_Average_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
