...
public class Momentum_Pct_Change_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Pct_Change_10"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Pct_Change_10 - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Pct_Change_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
