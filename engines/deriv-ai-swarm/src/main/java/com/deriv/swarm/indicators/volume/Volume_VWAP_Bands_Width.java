...
public class Volume_VWAP_Bands_Width implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume VWAP_Bands_Width"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume VWAP_Bands_Width - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume VWAP_Bands_Width: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
