...
public class Custom_Random_Forest_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Random_Forest_Signal"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Random_Forest_Signal - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Random_Forest_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
