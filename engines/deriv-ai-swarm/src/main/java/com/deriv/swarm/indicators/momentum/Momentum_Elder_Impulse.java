...
public class Momentum_Elder_Impulse implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Elder_Impulse"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Elder_Impulse - momentum indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Elder_Impulse: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
