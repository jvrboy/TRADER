...
public class Pattern_Bull_Pin_Bar_Confirm implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bull_Pin_Bar_Confirm"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bull_Pin_Bar_Confirm - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bull_Pin_Bar_Confirm: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
