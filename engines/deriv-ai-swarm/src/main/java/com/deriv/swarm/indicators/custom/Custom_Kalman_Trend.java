...
public class Custom_Kalman_Trend implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Kalman_Trend"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Kalman_Trend - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Kalman_Trend: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
