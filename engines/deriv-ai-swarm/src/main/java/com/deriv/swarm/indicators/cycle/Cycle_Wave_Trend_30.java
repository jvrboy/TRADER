...
public class Cycle_Wave_Trend_30 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Wave_Trend_30"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Wave_Trend_30 - cycle indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        int len = Math.min(30, closes.size());
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Wave_Trend_30: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
