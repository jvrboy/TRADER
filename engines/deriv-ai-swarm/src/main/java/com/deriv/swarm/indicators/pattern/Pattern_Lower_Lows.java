...
public class Pattern_Lower_Lows implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Lower_Lows"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Lower_Lows - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Lower_Lows: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
