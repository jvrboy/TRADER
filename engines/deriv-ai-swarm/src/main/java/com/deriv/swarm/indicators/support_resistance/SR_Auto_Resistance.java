...
public class SR_Auto_Resistance implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Auto_Resistance"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Auto_Resistance - support_resistance indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Auto_Resistance: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
