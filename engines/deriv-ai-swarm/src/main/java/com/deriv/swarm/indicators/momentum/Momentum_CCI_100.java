...
public class Momentum_CCI_100 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum CCI_100"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum CCI_100 - momentum indicator with period 100"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        int p = Math.min(100, closes.size());
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum CCI_100: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
