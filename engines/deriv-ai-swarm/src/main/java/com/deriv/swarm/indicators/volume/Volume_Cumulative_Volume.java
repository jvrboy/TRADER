...
public class Volume_Cumulative_Volume implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Cumulative_Volume"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Cumulative_Volume - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Cumulative_Volume: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
