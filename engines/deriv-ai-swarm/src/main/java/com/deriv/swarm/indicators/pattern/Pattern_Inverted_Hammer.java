...
public class Pattern_Inverted_Hammer implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Inverted_Hammer"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Inverted_Hammer - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Inverted_Hammer: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
