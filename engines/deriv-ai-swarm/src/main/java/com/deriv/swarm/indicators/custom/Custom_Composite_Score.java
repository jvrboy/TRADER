...
public class Custom_Composite_Score implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Composite_Score"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Composite_Score - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Composite_Score: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
