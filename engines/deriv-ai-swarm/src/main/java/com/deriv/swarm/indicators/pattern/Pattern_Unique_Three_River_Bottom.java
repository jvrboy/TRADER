...
public class Pattern_Unique_Three_River_Bottom implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Unique_Three_River_Bottom"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Unique_Three_River_Bottom - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Unique_Three_River_Bottom: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
