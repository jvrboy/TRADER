...
public class Pattern_Ascending_Triangle implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Ascending_Triangle"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Ascending_Triangle - pattern indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Ascending_Triangle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
