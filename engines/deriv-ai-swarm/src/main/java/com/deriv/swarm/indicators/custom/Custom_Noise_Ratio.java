...
public class Custom_Noise_Ratio implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Noise_Ratio"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Noise_Ratio - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Noise_Ratio: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
