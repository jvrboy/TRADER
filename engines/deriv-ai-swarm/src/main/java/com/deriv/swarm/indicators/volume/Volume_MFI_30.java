...
public class Volume_MFI_30 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume MFI_30"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume MFI_30 - volume indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume MFI_30: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
