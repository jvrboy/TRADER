...
public class Cycle_Cyclic_RSI_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Cyclic_RSI_14"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Cyclic_RSI_14 - cycle indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Cyclic_RSI_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
