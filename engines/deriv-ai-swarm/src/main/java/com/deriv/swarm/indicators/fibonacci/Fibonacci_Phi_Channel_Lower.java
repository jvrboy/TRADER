...
public class Fibonacci_Phi_Channel_Lower implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Phi_Channel_Lower"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Phi_Channel_Lower - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Phi_Channel_Lower: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
