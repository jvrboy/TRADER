...
public class Momentum_Momentum_Composite_Long implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Momentum_Composite_Long"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Momentum_Composite_Long - momentum indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Momentum_Composite_Long: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
