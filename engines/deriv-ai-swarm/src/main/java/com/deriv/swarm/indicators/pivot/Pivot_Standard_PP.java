...
public class Pivot_Standard_PP implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Standard_PP"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Standard_PP - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Standard_PP: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
