...
public class Cycle_Sin_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Sin_50"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Sin_50 - cycle indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        int len = Math.min(50, closes.size());
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Sin_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
