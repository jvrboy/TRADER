...
public class Pattern_Bullish_Concealing_Baby implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bullish_Concealing_Baby"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bullish_Concealing_Baby - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bullish_Concealing_Baby: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
