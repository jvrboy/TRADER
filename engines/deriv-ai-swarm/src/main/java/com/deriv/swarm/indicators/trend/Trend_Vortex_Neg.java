...
public class Trend_Vortex_Neg implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Vortex_Neg"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Vortex_Neg - trend indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Vortex_Neg: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
