...
public class Custom_Fractal_Filtered_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Fractal_Filtered_Signal"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Fractal_Filtered_Signal - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Fractal_Filtered_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
