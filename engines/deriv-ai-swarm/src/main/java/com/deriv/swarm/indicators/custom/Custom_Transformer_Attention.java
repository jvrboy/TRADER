...
public class Custom_Transformer_Attention implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Transformer_Attention"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Transformer_Attention - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Transformer_Attention: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
