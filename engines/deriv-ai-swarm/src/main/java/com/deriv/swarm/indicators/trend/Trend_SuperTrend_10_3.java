...
public class Trend_SuperTrend_10_3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SuperTrend_10_3"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SuperTrend_10_3 - trend indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SuperTrend_10_3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
