...
public class Custom_Machine_Learning_Score implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Machine_Learning_Score"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Machine_Learning_Score - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Machine_Learning_Score: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
