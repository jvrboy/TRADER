...
public class MarketProfile_Initial_Balance_Mid implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Initial_Balance_Mid"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Initial_Balance_Mid - market_profile indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Initial_Balance_Mid: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
