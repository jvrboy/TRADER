...
public class MarketProfile_Order_Block_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Order_Block_Bull"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Order_Block_Bull - market_profile indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Order_Block_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
