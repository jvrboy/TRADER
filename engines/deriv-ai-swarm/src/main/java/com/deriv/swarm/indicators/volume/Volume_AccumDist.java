...
public class Volume_AccumDist implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume AccumDist"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume AccumDist - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume AccumDist: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
