...
public class SR_Camarilla_R4 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Camarilla_R4"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Camarilla_R4 - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Camarilla_R4: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
