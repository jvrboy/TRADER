...
public class Pattern_Higher_Lows implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Higher_Lows"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Higher_Lows - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Higher_Lows: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
