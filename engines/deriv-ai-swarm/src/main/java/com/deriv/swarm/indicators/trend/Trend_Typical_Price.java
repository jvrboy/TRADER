...
public class Trend_Typical_Price implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Typical_Price"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Typical_Price - trend indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Typical_Price: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
