...
public class Trend_MIDPOINT implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend MIDPOINT"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend MIDPOINT - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend MIDPOINT: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
