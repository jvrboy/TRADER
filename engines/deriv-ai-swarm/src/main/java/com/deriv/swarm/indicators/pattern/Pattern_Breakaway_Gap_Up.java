...
public class Pattern_Breakaway_Gap_Up implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Breakaway_Gap_Up"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Breakaway_Gap_Up - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Breakaway_Gap_Up: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
