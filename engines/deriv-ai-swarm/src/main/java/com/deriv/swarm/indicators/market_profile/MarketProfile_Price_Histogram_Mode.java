...
public class MarketProfile_Price_Histogram_Mode implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Price_Histogram_Mode"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Price_Histogram_Mode - market_profile indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Price_Histogram_Mode: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
