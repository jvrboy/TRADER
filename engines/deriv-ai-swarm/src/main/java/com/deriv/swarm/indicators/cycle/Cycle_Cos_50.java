...
public class Cycle_Cos_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Cos_50"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Cos_50 - cycle indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Cos_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
