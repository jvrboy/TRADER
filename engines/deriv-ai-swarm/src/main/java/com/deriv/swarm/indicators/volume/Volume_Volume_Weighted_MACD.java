...
public class Volume_Volume_Weighted_MACD implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Weighted_MACD"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Weighted_MACD - volume indicator with period 26"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Weighted_MACD: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
