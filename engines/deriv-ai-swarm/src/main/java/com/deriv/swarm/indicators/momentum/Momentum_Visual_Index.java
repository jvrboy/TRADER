...
public class Momentum_Visual_Index implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Visual_Index"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Visual_Index - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Visual_Index: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
