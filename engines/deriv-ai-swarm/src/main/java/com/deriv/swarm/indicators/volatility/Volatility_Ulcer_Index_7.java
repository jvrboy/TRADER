...
public class Volatility_Ulcer_Index_7 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Ulcer_Index_7"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Ulcer_Index_7 - volatility indicator with period 7"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(7, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Ulcer_Index_7: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
