...
public class Momentum_Klinger_Osc implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Klinger_Osc"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Klinger_Osc - momentum indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Klinger_Osc: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
