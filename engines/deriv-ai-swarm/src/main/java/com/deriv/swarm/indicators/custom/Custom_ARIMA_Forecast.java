...
public class Custom_ARIMA_Forecast implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom ARIMA_Forecast"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom ARIMA_Forecast - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom ARIMA_Forecast: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
