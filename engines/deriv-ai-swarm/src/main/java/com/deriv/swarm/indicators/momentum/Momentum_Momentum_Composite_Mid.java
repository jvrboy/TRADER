...
public class Momentum_Momentum_Composite_Mid implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Momentum_Composite_Mid"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Momentum_Composite_Mid - momentum indicator with period 28"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Momentum_Composite_Mid: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
