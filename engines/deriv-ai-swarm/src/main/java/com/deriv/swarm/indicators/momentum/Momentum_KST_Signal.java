...
public class Momentum_KST_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum KST_Signal"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum KST_Signal - momentum indicator with period 9"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum KST_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
