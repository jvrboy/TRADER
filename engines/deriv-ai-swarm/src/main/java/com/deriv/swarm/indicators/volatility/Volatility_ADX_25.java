...
public class Volatility_ADX_25 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility ADX_25"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility ADX_25 - volatility indicator with period 25"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility ADX_25: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
