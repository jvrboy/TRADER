...
public class Volume_AD_Line implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume AD_Line"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume AD_Line - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume AD_Line: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
