...
public class Trend_LR_Projected_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend LR_Projected_5"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend LR_Projected_5 - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend LR_Projected_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
