...
public class Volatility_Volatility_Ratio_10_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Volatility_Ratio_10_50"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Volatility_Ratio_10_50 - volatility indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Volatility_Ratio_10_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
