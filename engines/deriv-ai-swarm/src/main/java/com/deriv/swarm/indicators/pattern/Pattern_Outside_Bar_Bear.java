...
public class Pattern_Outside_Bar_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Outside_Bar_Bear"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Outside_Bar_Bear - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Outside_Bar_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
