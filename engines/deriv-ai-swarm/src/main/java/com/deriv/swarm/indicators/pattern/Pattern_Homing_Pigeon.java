...
public class Pattern_Homing_Pigeon implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Homing_Pigeon"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Homing_Pigeon - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Homing_Pigeon: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
