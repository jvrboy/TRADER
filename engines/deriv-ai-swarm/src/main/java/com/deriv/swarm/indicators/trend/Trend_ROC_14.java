...
public class Trend_ROC_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend ROC_14"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend ROC_14 - trend indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend ROC_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
