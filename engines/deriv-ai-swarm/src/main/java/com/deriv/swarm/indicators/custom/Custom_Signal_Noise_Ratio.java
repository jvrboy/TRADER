...
public class Custom_Signal_Noise_Ratio implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Signal_Noise_Ratio"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Signal_Noise_Ratio - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Signal_Noise_Ratio: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
