...
public class Trend_WMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend WMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend WMA - trend indicator with period 100"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.wma(closes, 100);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend WMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
