...
public class SR_Fib_Pivot_S2 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Fib_Pivot_S2"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Fib_Pivot_S2 - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Fib_Pivot_S2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
