...
public class Trend_FRAMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend FRAMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend FRAMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend FRAMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
