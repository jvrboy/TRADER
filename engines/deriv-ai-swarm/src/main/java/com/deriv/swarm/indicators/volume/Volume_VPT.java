...
public class Volume_VPT implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume VPT"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume VPT - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume VPT: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
