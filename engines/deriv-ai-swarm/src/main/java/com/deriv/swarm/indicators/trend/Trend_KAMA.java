...
public class Trend_KAMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend KAMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend KAMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend KAMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
