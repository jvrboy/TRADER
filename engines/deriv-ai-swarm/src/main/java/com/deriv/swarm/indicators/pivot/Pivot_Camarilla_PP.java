...
public class Pivot_Camarilla_PP implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Camarilla_PP"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Camarilla_PP - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Camarilla_PP: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
