...
public class Stat_CV_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical CV_10"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical CV_10 - statistical indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical CV_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
