...
public class Volatility_BB_Width_20_3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility BB_Width_20_3"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility BB_Width_20_3 - volatility indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility BB_Width_20_3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
