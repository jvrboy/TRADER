...
public class Trend_HMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend HMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend HMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend HMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
