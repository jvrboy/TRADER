...
public class Momentum_Awesome_Oscillator_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Awesome_Oscillator_Signal"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Awesome_Oscillator_Signal - momentum indicator with period 34"; }

    @Override
    public int getMinCandles() { return 34; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(34, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Awesome_Oscillator_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
