...
public class Trend_Momentum_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Momentum_5"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Momentum_5 - trend indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Momentum_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
