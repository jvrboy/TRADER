...
public class Trend_SMMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SMMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SMMA - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SMMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
