...
public class Trend_Vortex_Pos implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Vortex_Pos"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Vortex_Pos - trend indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Vortex_Pos: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
