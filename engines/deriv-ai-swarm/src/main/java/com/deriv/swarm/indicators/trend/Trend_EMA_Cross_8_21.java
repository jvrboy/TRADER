...
public class Trend_EMA_Cross_8_21 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend EMA_Cross_8_21"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend EMA_Cross_8_21 - trend indicator with period 21"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 21);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend EMA_Cross_8_21: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
