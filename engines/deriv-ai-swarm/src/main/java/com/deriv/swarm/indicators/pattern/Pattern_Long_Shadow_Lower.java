...
public class Pattern_Long_Shadow_Lower implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Long_Shadow_Lower"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Long_Shadow_Lower - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Long_Shadow_Lower: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
