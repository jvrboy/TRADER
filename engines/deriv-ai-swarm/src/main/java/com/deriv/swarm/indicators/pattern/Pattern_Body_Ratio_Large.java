...
public class Pattern_Body_Ratio_Large implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Body_Ratio_Large"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Body_Ratio_Large - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Body_Ratio_Large: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
