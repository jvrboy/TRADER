...
public class Momentum_Fisher_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Fisher_Signal"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Fisher_Signal - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Fisher_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
