...
public class Pivot_PP_Distance_R1 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot PP_Distance_R1"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot PP_Distance_R1 - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot PP_Distance_R1: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
