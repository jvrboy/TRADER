...
public class Pattern_Higher_Highs implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Higher_Highs"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Higher_Highs - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Higher_Highs: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
