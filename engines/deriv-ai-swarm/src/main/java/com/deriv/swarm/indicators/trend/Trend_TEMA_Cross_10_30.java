...
public class Trend_TEMA_Cross_10_30 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend TEMA_Cross_10_30"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend TEMA_Cross_10_30 - trend indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend TEMA_Cross_10_30: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
