...
public class Momentum_Psychological_Line_12 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Psychological_Line_12"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Psychological_Line_12 - momentum indicator with period 12"; }

    @Override
    public int getMinCandles() { return 12; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(12, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Psychological_Line_12: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
