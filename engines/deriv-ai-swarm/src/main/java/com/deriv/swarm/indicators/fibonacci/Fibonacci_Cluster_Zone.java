...
public class Fibonacci_Cluster_Zone implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Cluster_Zone"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Cluster_Zone - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Cluster_Zone: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
