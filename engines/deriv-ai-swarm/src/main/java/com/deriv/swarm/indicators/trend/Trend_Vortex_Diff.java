...
public class Trend_Vortex_Diff implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Vortex_Diff"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Vortex_Diff - trend indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Vortex_Diff: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
