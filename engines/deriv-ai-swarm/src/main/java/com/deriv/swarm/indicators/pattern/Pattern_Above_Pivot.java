...
public class Pattern_Above_Pivot implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Above_Pivot"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Above_Pivot - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Above_Pivot: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
