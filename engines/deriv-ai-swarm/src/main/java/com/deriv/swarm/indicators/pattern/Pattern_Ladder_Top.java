...
public class Pattern_Ladder_Top implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Ladder_Top"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Ladder_Top - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Ladder_Top: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
