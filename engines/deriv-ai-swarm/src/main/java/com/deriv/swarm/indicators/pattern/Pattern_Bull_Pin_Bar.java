...
public class Pattern_Bull_Pin_Bar implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bull_Pin_Bar"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bull_Pin_Bar - pattern indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bull_Pin_Bar: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
