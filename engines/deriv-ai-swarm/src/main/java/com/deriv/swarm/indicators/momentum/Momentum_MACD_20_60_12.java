...
public class Momentum_MACD_20_60_12 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MACD_20_60_12"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MACD_20_60_12 - momentum indicator with period 60"; }

    @Override
    public int getMinCandles() { return 60; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MACD_20_60_12: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
