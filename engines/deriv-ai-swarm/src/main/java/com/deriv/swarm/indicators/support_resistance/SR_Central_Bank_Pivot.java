...
public class SR_Central_Bank_Pivot implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Central_Bank_Pivot"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Central_Bank_Pivot - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Central_Bank_Pivot: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
