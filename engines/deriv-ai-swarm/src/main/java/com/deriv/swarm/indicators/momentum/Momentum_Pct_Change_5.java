...
public class Momentum_Pct_Change_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Pct_Change_5"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Pct_Change_5 - momentum indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Pct_Change_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
