...
public class Volatility_Daily_Range_ATR_Ratio implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Daily_Range_ATR_Ratio"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Daily_Range_ATR_Ratio - volatility indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.stddev(closes, Math.min(14, closes.size()));
        double price = candles.get(candles.size()-1).getClose();
        double mean = IndicatorMath.sma(closes, Math.min(14, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Daily_Range_ATR_Ratio: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
