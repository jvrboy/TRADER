...
public class Cycle_Cycle_Detector_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Cycle_Detector_20"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Cycle_Detector_20 - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Cycle_Detector_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
