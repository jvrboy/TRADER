...
public class Momentum_RSI_2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum RSI_2"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum RSI_2 - momentum indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.rsi(closes, 2);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum RSI_2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
