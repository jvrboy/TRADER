...
public class Custom_Complexity_Score implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Complexity_Score"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Complexity_Score - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Complexity_Score: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
