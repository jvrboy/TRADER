...
public class Cycle_Phase_Angle_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Phase_Angle_20"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Phase_Angle_20 - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Phase_Angle_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
