...
public class Volatility_True_Range_EMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility True_Range_EMA"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility True_Range_EMA - volatility indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 14);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility True_Range_EMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
