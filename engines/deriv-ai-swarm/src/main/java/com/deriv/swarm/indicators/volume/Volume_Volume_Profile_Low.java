...
public class Volume_Volume_Profile_Low implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Profile_Low"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Profile_Low - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Profile_Low: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
