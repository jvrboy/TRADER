...
public class Trend_Ichimoku_Cloud_Thickness implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Ichimoku_Cloud_Thickness"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Ichimoku_Cloud_Thickness - trend indicator with period 52"; }

    @Override
    public int getMinCandles() { return 52; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(52, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Ichimoku_Cloud_Thickness: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
