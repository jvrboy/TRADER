...
public class SR_Demark_S1 implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Demark_S1"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Demark_S1 - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Demark_S1: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
