...
public class Pattern_Lower_Highs implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Lower_Highs"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Lower_Highs - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Lower_Highs: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
