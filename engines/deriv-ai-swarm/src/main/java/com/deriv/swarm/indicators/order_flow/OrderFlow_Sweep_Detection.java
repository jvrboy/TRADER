...
public class OrderFlow_Sweep_Detection implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Sweep_Detection"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Sweep_Detection - order_flow indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Sweep_Detection: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
