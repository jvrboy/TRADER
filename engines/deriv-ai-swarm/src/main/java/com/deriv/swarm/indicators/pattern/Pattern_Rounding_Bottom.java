...
public class Pattern_Rounding_Bottom implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Rounding_Bottom"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Rounding_Bottom - pattern indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Rounding_Bottom: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
