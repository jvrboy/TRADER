...
public class Stat_Mean_100 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Mean_100"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Mean_100 - statistical indicator with period 100"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double mean = IndicatorMath.sma(closes, Math.min(100, closes.size()));
        double std = IndicatorMath.stddev(closes, Math.min(100, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Mean_100: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
