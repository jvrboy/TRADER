...
public class Pivot_Quarterly_PP implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Quarterly_PP"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Quarterly_PP - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Quarterly_PP: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
