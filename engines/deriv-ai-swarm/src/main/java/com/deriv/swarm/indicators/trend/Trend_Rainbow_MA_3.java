...
public class Trend_Rainbow_MA_3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Rainbow_MA_3"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Rainbow_MA_3 - trend indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Rainbow_MA_3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
