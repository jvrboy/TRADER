...
public class Trend_SAR_Step_002 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SAR_Step_002"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SAR_Step_002 - trend indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SAR_Step_002: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
