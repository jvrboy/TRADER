...
public class Fibonacci_Extension_2000 implements TechnicalIndicator {

    @Override
    public String getName() { return "Fibonacci Extension_2000"; }

    @Override
    public String getCategory() { return "fibonacci"; }

    @Override
    public String getDescription() { return "Fibonacci Extension_2000 - fibonacci indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Fibonacci Extension_2000: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
