...
public class Volume_AccumDist_SMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume AccumDist_SMA"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume AccumDist_SMA - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume AccumDist_SMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
