...
public class Momentum_MACD_Histogram_5_34 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MACD_Histogram_5_34"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MACD_Histogram_5_34 - momentum indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MACD_Histogram_5_34: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
