...
public class Pattern_Deliberation implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Deliberation"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Deliberation - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Deliberation: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
