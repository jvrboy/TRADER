...
public class Pattern_Inside_Bar_Breakout_Down implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Inside_Bar_Breakout_Down"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Inside_Bar_Breakout_Down - pattern indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Inside_Bar_Breakout_Down: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
