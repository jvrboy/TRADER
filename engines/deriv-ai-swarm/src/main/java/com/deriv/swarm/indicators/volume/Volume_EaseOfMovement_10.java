...
public class Volume_EaseOfMovement_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume EaseOfMovement_10"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume EaseOfMovement_10 - volume indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume EaseOfMovement_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
