...
public class Momentum_Balance_of_Power implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Balance_of_Power"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Balance_of_Power - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Balance_of_Power: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
