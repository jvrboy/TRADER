...
public class Pattern_Four_Up_Consecutive implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Four_Up_Consecutive"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Four_Up_Consecutive - pattern indicator with period 4"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Four_Up_Consecutive: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
