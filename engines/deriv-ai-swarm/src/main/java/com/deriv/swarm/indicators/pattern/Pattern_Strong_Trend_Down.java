...
public class Pattern_Strong_Trend_Down implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Strong_Trend_Down"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Strong_Trend_Down - pattern indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Strong_Trend_Down: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
