...
public class Custom_Adaptive_Threshold implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Adaptive_Threshold"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Adaptive_Threshold - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Adaptive_Threshold: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
