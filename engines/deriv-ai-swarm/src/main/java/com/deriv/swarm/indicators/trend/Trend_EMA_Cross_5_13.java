...
public class Trend_EMA_Cross_5_13 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend EMA_Cross_5_13"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend EMA_Cross_5_13 - trend indicator with period 13"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 13);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend EMA_Cross_5_13: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
