...
public class Trend_SMA_Cross_50_200 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend SMA_Cross_50_200"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend SMA_Cross_50_200 - trend indicator with period 200"; }

    @Override
    public int getMinCandles() { return 200; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 200);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend SMA_Cross_50_200: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
