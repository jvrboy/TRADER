...
public class Momentum_Williams_AD implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Williams_AD"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Williams_AD - momentum indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Williams_AD: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
