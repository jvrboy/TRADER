...
public class MarketProfile_D_Dual_Acceptance implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile D_Dual_Acceptance"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile D_Dual_Acceptance - market_profile indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile D_Dual_Acceptance: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
