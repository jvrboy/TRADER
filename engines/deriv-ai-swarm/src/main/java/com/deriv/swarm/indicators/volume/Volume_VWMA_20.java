...
public class Volume_VWMA_20 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume VWMA_20"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume VWMA_20 - volume indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.wma(closes, 20);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume VWMA_20: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
