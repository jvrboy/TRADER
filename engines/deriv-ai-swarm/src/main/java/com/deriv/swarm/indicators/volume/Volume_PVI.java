...
public class Volume_PVI implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume PVI"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume PVI - volume indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume PVI: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
