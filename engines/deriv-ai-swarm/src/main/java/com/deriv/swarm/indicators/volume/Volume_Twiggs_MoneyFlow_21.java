...
public class Volume_Twiggs_MoneyFlow_21 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Twiggs_MoneyFlow_21"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Twiggs_MoneyFlow_21 - volume indicator with period 21"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Twiggs_MoneyFlow_21: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
