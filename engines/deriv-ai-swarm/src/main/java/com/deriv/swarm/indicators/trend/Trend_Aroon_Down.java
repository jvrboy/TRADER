...
public class Trend_Aroon_Down implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Aroon_Down"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Aroon_Down - trend indicator with period 25"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Aroon_Down: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
