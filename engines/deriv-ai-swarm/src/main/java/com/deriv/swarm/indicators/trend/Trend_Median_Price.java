...
public class Trend_Median_Price implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Median_Price"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Median_Price - trend indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Median_Price: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
