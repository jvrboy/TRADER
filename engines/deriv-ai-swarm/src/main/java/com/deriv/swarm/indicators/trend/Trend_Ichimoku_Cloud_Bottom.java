...
public class Trend_Ichimoku_Cloud_Bottom implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Ichimoku_Cloud_Bottom"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Ichimoku_Cloud_Bottom - trend indicator with period 52"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Ichimoku_Cloud_Bottom: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
