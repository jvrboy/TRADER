...
public class Volatility_Projection_Band_Lower implements TechnicalIndicator {

    @Override
    public String getName() { return "Volatility Projection_Band_Lower"; }

    @Override
    public String getCategory() { return "volatility"; }

    @Override
    public String getDescription() { return "Volatility Projection_Band_Lower - volatility indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volatility Projection_Band_Lower: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
