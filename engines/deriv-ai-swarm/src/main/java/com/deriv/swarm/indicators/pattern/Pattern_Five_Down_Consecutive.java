...
public class Pattern_Five_Down_Consecutive implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Five_Down_Consecutive"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Five_Down_Consecutive - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Five_Down_Consecutive: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
