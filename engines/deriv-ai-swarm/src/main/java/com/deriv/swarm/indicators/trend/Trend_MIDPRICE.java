...
public class Trend_MIDPRICE implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend MIDPRICE"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend MIDPRICE - trend indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend MIDPRICE: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
