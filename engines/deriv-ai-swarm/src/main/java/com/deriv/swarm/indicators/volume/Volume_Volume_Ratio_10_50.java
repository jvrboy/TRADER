...
public class Volume_Volume_Ratio_10_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Volume_Ratio_10_50"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Volume_Ratio_10_50 - volume indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Volume_Ratio_10_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
