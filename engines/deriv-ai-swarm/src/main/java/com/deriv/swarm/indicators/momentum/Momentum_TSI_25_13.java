...
public class Momentum_TSI_25_13 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum TSI_25_13"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum TSI_25_13 - momentum indicator with period 25"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum TSI_25_13: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
