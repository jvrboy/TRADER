...
public class Momentum_Ultimate_Oscillator_7_14_28 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Ultimate_Oscillator_7_14_28"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Ultimate_Oscillator_7_14_28 - momentum indicator with period 28"; }

    @Override
    public int getMinCandles() { return 28; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(28, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Ultimate_Oscillator_7_14_28: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
