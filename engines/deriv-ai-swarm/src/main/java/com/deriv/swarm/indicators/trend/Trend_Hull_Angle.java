...
public class Trend_Hull_Angle implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Hull_Angle"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Hull_Angle - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Hull_Angle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
