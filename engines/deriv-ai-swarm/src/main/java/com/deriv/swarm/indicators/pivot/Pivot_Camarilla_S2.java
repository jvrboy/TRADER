...
public class Pivot_Camarilla_S2 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Camarilla_S2"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Camarilla_S2 - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Camarilla_S2: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
