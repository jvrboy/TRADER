...
public class Trend_DEMA implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend DEMA"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend DEMA - trend indicator with period 100"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend DEMA: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
