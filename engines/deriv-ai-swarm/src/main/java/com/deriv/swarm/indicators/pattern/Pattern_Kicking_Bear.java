...
public class Pattern_Kicking_Bear implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Kicking_Bear"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Kicking_Bear - pattern indicator with period 2"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Kicking_Bear: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
