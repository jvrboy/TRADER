...
public class Stat_Kurtosis_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Statistical Kurtosis_50"; }

    @Override
    public String getCategory() { return "statistical"; }

    @Override
    public String getDescription() { return "Statistical Kurtosis_50 - statistical indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Statistical Kurtosis_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
