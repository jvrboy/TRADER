...
public class Trend_DEMA_Cross_10_30 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend DEMA_Cross_10_30"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend DEMA_Cross_10_30 - trend indicator with period 30"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.ema(closes, 30);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend DEMA_Cross_10_30: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
