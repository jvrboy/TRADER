...
public class Volume_Tick_Volume_RSI_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Volume Tick_Volume_RSI_14"; }

    @Override
    public String getCategory() { return "volume"; }

    @Override
    public String getDescription() { return "Volume Tick_Volume_RSI_14 - volume indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Volume Tick_Volume_RSI_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
