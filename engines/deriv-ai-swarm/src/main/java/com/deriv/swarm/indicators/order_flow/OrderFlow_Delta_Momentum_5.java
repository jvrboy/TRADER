...
public class OrderFlow_Delta_Momentum_5 implements TechnicalIndicator {

    @Override
    public String getName() { return "Order Flow Delta_Momentum_5"; }

    @Override
    public String getCategory() { return "order_flow"; }

    @Override
    public String getDescription() { return "Order Flow Delta_Momentum_5 - order_flow indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        int len = Math.min(5, closes.size());
        double delta = 0;
        for (int i = 0; i < len; i++) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Order Flow Delta_Momentum_5: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
