...
public class Trend_Rainbow_MA_4 implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Rainbow_MA_4"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Rainbow_MA_4 - trend indicator with period 4"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(4, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Rainbow_MA_4: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
