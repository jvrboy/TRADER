...
public class MarketProfile_Fair_Value_Gap_Up implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Fair_Value_Gap_Up"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Fair_Value_Gap_Up - market_profile indicator with period 3"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Fair_Value_Gap_Up: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
