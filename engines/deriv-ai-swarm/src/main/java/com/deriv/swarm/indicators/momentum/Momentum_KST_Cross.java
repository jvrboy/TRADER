...
public class Momentum_KST_Cross implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum KST_Cross"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum KST_Cross - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum KST_Cross: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
