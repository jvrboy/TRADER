...
public class SR_Pivot_Point implements TechnicalIndicator {

    @Override
    public String getName() { return "S/R Pivot_Point"; }

    @Override
    public String getCategory() { return "support_resistance"; }

    @Override
    public String getDescription() { return "S/R Pivot_Point - support_resistance indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "S/R Pivot_Point: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
