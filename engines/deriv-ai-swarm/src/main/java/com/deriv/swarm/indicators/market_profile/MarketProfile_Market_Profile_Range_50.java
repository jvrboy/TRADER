...
public class MarketProfile_Market_Profile_Range_50 implements TechnicalIndicator {

    @Override
    public String getName() { return "Market Profile Market_Profile_Range_50"; }

    @Override
    public String getCategory() { return "market_profile"; }

    @Override
    public String getDescription() { return "Market Profile Market_Profile_Range_50 - market_profile indicator with period 50"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, Math.min(50, closes.size()));
        double high = IndicatorMath.max(closes, Math.min(50, closes.size()));
        double low = IndicatorMath.min(closes, Math.min(50, closes.size()));
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Market Profile Market_Profile_Range_50: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
