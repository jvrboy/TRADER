...
public class Momentum_MFI_Overbought_14 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum MFI_Overbought_14"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum MFI_Overbought_14 - momentum indicator with period 14"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum MFI_Overbought_14: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
