...
public class Cycle_Schaff_Cycle_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Schaff_Cycle_10"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Schaff_Cycle_10 - cycle indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Schaff_Cycle_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
