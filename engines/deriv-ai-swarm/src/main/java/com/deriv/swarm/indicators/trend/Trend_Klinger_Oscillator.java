...
public class Trend_Klinger_Oscillator implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Klinger_Oscillator"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Klinger_Oscillator - trend indicator with period 34"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Klinger_Oscillator: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
