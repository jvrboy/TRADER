...
public class Cycle_Ehlers_Stochastic_Cycle implements TechnicalIndicator {

    @Override
    public String getName() { return "Cycle Ehlers_Stochastic_Cycle"; }

    @Override
    public String getCategory() { return "cycle"; }

    @Override
    public String getDescription() { return "Cycle Ehlers_Stochastic_Cycle - cycle indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Cycle Ehlers_Stochastic_Cycle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
