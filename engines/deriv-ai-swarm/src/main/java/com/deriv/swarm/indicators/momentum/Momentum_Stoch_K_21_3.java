...
public class Momentum_Stoch_K_21_3 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Stoch_K_21_3"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Stoch_K_21_3 - momentum indicator with period 21"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Stoch_K_21_3: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
