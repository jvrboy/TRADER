...
public class Custom_Neural_Net_Signal implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Neural_Net_Signal"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Neural_Net_Signal - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Neural_Net_Signal: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
