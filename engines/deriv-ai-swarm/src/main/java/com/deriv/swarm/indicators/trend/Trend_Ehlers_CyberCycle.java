...
public class Trend_Ehlers_CyberCycle implements TechnicalIndicator {

    @Override
    public String getName() { return "Trend Ehlers_CyberCycle"; }

    @Override
    public String getCategory() { return "trend"; }

    @Override
    public String getDescription() { return "Trend Ehlers_CyberCycle - trend indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Trend Ehlers_CyberCycle: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
