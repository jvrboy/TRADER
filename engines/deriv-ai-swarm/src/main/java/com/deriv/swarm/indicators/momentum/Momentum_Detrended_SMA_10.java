...
public class Momentum_Detrended_SMA_10 implements TechnicalIndicator {

    @Override
    public String getName() { return "Momentum Detrended_SMA_10"; }

    @Override
    public String getCategory() { return "momentum"; }

    @Override
    public String getDescription() { return "Momentum Detrended_SMA_10 - momentum indicator with period 10"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        double value = IndicatorMath.sma(closes, 10);
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Momentum Detrended_SMA_10: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
