...
public class Custom_Signal_Quality_Score implements TechnicalIndicator {

    @Override
    public String getName() { return "Custom Signal_Quality_Score"; }

    @Override
    public String getCategory() { return "custom"; }

    @Override
    public String getDescription() { return "Custom Signal_Quality_Score - custom indicator with period 20"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Custom Signal_Quality_Score: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
