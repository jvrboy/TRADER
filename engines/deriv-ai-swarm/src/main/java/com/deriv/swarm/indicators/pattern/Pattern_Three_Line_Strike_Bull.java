...
public class Pattern_Three_Line_Strike_Bull implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Three_Line_Strike_Bull"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Three_Line_Strike_Bull - pattern indicator with period 4"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Three_Line_Strike_Bull: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
