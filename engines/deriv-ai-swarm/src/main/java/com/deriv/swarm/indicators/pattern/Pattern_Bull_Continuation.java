...
public class Pattern_Bull_Continuation implements TechnicalIndicator {

    @Override
    public String getName() { return "Pattern Bull_Continuation"; }

    @Override
    public String getCategory() { return "pattern"; }

    @Override
    public String getDescription() { return "Pattern Bull_Continuation - pattern indicator with period 5"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pattern Bull_Continuation: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
