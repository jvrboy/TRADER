...
public class Pivot_Mid_Points_R2_R1 implements TechnicalIndicator {

    @Override
    public String getName() { return "Pivot Mid_Points_R2_R1"; }

    @Override
    public String getCategory() { return "pivot"; }

    @Override
    public String getDescription() { return "Pivot Mid_Points_R2_R1 - pivot indicator with period 1"; }
    ...
    public IndicatorResult calculate(List<Candle> candles, String symbol, String timeframe) {
        ...
        return new IndicatorResult(getName(), symbol, timeframe,
            ...
            "Pivot Mid_Points_R2_R1: value=" + String.format("%.5f", value) + " signal=" + signal);
    }
}
